...
- [x] **G1a** thread mode through dispatch (mechanical) — **DONE** (`3a14b59`) ·
  ...
  G5 I2S+auto-dict — **NEXT** · G6 transparency descriptor + closed/directed algebra +
