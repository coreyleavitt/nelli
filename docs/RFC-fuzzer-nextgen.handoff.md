...
- [x] **G1a** thread mode through dispatch (mechanical) — **DONE** (`3a14b59`) ·
  ...
  [ ] G3 orchestration (Z3 bridge off hot path) — **NEXT** (S1's real energy/
  `FrontierStats` now available; no G3b throwaway needed, see the REORDER
  note above) · G4 cmp instrumentation ·
