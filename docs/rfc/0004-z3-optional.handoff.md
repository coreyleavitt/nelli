...
| R1-10 | Low | **fixed** | `docs/rfc/0004-z3-optional.md:4-7,204,294,750,826` | RFC text stale vs shipped: status header still "stage 2 … S1a READY for `/tdd`"; `:204` shows `assist: typed` though the gate adopted `untyped`; `:294`/`:750` cite `caoRejectedAtReplay`; `:826` half-(2) snippet pins one test where CI pins four. | read each line |
