...
| [ADR-0030](ADR-0030-boundary-normalization.md) | Boundary normalization — the walker's input language is defined by what the boundary emits, not what the compiler can produce | Accepted 2026-08-14 |
